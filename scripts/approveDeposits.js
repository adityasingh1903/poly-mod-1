...
const ABI = require('../artifacts/contracts/ETHArtifact');
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("ETHArtifact");
  const nft = await NFT.attach('0x9a4Ce73d80D1d17c4f4DD3CE8AF4cD5dE19a346A');
